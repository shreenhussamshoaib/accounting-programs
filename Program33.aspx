<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Program33.aspx.vb" Inherits="Program33" %>
...
<body style="padding: 0px; margin: 0px">
    ...
    <div class="row" id="Divpicture" runat="server">
        <div class="col-md-12" align="center" style="padding-top:30px;">
            <asp:Image ID="ImageWelcome" runat="server" ImageUrl="~/Pic/P3.png" CssClass ="img" Width="429px" Height="246px" />
        </div> 
