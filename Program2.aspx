<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Program2.aspx.vb" Inherits="Program2" %>
...
<body style="padding: 0px; margin: 0px">
    <form id="form1" runat="server" >
        ...
        <div align="right" style="padding: 5px 30px 0px 30px; font-family:'Arial'; font-size: 26px; font-weight: bolder;float: right">
            <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/Program22.aspx">Download</asp:LinkButton>
        </div>

<div class="slideshow-container">
        <div class="mySlides fade">
  <div class="numbertext">1 / 3</div>
  <img src="Pic/P2.png" style="width:100%; height :100%;" />
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Pic/P22.png" style="width:100%; height :100%;" />
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Pic/P21.png" style="width:100%; height :100%;" />
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span> 
        ...
        <div align="center" style="background-color: #99CCFF; padding-left:90px ; padding-right:90px;">
            <br />
            <h3>برنامج لادارج صالات الجيم والنوادي وصالات اللياقة البدنية</h3>
            <h3>لتسجيل الاشتراكات ومتابعتها ومتابعت العملاء وحساباتهم وكذلك لتسجيل الحضور والانصراف للكلاسات</h3>
            <br />
        </div>
