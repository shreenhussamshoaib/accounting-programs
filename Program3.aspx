<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Program3.aspx.vb" Inherits="Program3" %>
...
<body style="padding: 0px; margin: 0px">
    <form id="form1" runat="server" >
        ...
        <div align="right" style="padding: 5px 30px 0px 30px; font-family:'Arial'; font-size: 26px; font-weight: bolder;float: right">
            <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/Program33.aspx">Download</asp:LinkButton>
        </div>

<div class="slideshow-container">
        <div class="mySlides fade">
  <div class="numbertext">1 / 3</div>
  <img src="Pic/P3.png" style="width:100%; height :100%;" />
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Pic/P31.png" style="width:100%; height :100%;" />
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Pic/P32.png" style="width:100%; height :100%;" />
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span> 
        ...
        <div align="center" style="background-color: #99CCFF; padding-left:90px ; padding-right:90px;">
            <br />
            <h3>برنامج لادارة اعمال المتخصصين في مجالات الدعاية والاعلان</h3>
            <h3>تسهيل كبير في تتبع الاوردارات وتسليمها او شحنها للعملاء</h3>
            <h3>تتبع لدورة العمل الخاصة بكل عميل</h3>
            <br />
        </div>
